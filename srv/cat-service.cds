...
service CatalogService {
    ...
    action GetTabellaFiltrata9(entity: array of String, year: String, period:String) returns array of String;
    ...
    action applyFilters9(entity: array of String , year: String, period:String,) returns type.Filters;
